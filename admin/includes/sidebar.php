...
{               ?>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Bus<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-category.php">Add Bus</a>
                            </li>
                            <li>
                                <a href="manage-category.php">Manage Bus</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Driver Management<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add driver.php">Add Bus Driver</a>
                            </li>
                            <li>
                                <a href="driver management.php">Manage BUS Driver</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
